<template>
   <main class="main">
            <!-- Breadcrumb -->
            <ol class="breadcrumb">
                <li class="breadcrumb-item active"><a href="/">FARMACENTER WEB - MOVIL</a></li>
            </ol>
                        ...
                        <table class="table table-bordered table-striped table-sm">
                            ...
                            <tbody>
                                ...
                                <tr v-for="producto in arrayProducto" :key="producto.id">
                                    ...
                                    <td v-text="producto.concentracion"></td>
                                    <td v-text="producto.presentation"></td>
                                    <td v-text="producto.medida"></td>
                                    <td v-text="producto.precio_venta"></td>
                                    <td v-text="producto.stock"></td>
                                    <td v-text="producto.stockfraccion"></td>
